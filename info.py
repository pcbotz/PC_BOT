...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/86b50f3a69ce4ef16fb07.jpg")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/4cb437d0cd10446114fcc.jpg')
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>എതൊക്കെ മൂവി എപ്പോഴൊക്കെ OTT യിൽ റിലീസ് ആവും ?\n\nമൂവി OTT യിൽ വന്നോ?\n\nഎന്നൊക്കെ ഉള്ള അപ്ഡേറ്റുകൾ അറിയാൻ താല്പര്യം ഉള്ളവർക്ക് OTT അപ്ഡേറ്റ് ചാനലിൽ ജോയിൻ ചെയ്യാം..!!!\n\nNB : OTT യിൽ മൂവി റിലീസ് അയാൽ മാത്രമേ ടെലിഗ്രാമിൽ മൂവി വരൂ..!!📌</b>')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'ARAKAL_THERAVAD_MOVIES_02') # owner username without @

#pm_group_links_and_pic
PAYMENT_QRS = environ.get('PAYMENT_QRS', 'https://telegra.ph/file/2e719fb07a32ef4221b35.jpg')
PAYMENT_TEXT = environ.get('PAYMENT_TEXTS', '<b>👉 𝗟𝗔𝗧𝗘𝗦𝗧 𝗠𝗔𝗟𝗔𝗬𝗔𝗟𝗔𝗠 , 𝗧𝗔𝗠𝗜𝗟 ,  𝗘𝗡𝗚𝗟𝗜𝗦𝗛 , 𝗧𝗘𝗟𝗨𝗚𝗨 ,  𝗞𝗔𝗡𝗡𝗔𝗗𝗔 ,  𝗛𝗜𝗡𝗗𝗜 ,  𝗠𝗢𝗩𝗜𝗘𝗦 ✌️\n\nപുതിയതും പഴയതുമായ എല്ലാ മൂവിയും ലഭിക്കാൻ തഴെ ഉള്ള ലിങ്കിൽ കയറി സ്പെല്ലിംങ്ങ് തെറ്റാതെ മെസ്സേജ് അയക്കുക..!!!\n\n🔰 𝗚𝗥𝗢𝗨𝗣  𝗝 𝗢 𝗜 𝗡 ❤️ 𝗡 𝗢 𝗪 .🔥  𝗟𝗜𝗡𝗞  👇</b>')

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ARAKAL_THERAVAD_GROUP_04')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ARAKAL_THERAVAD_GROUP_LINKS')
