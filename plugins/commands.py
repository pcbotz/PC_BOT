...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgIAAxkBAAELoyVl6o7mqNsyJgKBszgCUxIfZgcGRAACdhEAAsMAASlJLbkjGWa6Dog0BA") 
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            ...
            photo="https://graph.org/file/aa2c135e6d312b2d85ef8.jpg",
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/PCADMINOFFICIALBOT")
                            ],
                            [
